export default {
  ...
  persona: {
    ...
    bkPasswordKeep: 'Password set. Leave empty to keep unchanged.',
  ...
  configDesc: {
    ...
    GTRENDS_LOOKBACK_DAYS: 'Google Trends lookback days',
    GTRENDS_TOP_N: 'Top N trends to pull',
    ENABLE_FB_VIRAL: 'Include MediaLens-FB viral posts',
    ENABLE_LIHKG: 'Include MediaLens-LIHKG in trend pulls',
    ...
    TREND_LOOKBACK_DAYS: 'MediaLens trend lookback days',
    ...
    // task pause controls
    SCANNER_PAUSED: 'Pause scanner task',
    TRENDS_PAUSED: 'Pause trends pull task',
    POSTER_PAUSED: 'Pause poster task',
    GTRENDS_PAUSED: 'Pause Google Trends pull task',
  },
