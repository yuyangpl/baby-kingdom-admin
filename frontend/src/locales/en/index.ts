export default {
  ...
  user: {
    ...
    roleDesc: {
      admin: 'Full system access. Manage users, configure settings, approve/reject content, and access all queues and audit logs.',
      editor: 'Content management. Claim feeds, edit and approve AI-generated replies, manage personas and tones.',
      viewer: 'Read-only access. View dashboard, feeds, queue status, and audit logs without making changes.',
    },
    you: 'You',
